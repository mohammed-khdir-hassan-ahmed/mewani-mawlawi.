  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-[85vw] max-w-xs md:max-w-sm max-h-[80vh] overflow-y-auto p-2 md:p-4">
        

          {/* Content */}
          <div className="bg-white rounded-t-3xl p-2 space-y-1.5">
             {/* Logo & Name */}
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg p-2 border border-pink-200">
             ...
             <p className='font-bold text-[7px]'>سۆشیاڵ میدیاکانمان:</p>
              ...
              <div className="flex gap-1">
                ...
                <a
                  ...
                  className="flex-1 bg-yellow-400 hover:bg-yellow-500 rounded-md p-1 flex flex-col items-center gap-0.5 transition-all hover:scale-105"
                >
                  <svg
                  ...
                  <span className="text-[6px] font-bold text-white">Snap</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 bg-green-500 hover:bg-green-600 rounded-md p-1 flex flex-col items-center gap-0.5 transition-all hover:scale-105"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="12"
                  ...
                  <span className="text-[6px] font-bold text-white">WhatsApp</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 bg-purple-600 hover:bg-purple-700 rounded-md p-1 flex flex-col items-center gap-0.5 transition-all hover:scale-105"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="12"
                  ...
                  <span className="text-[6px] font-bold text-white">Viber</span>
                </a>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-2 border-2 border-blue-200">
              ...
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <p className="text-[7px] font-bold text-blue-900 uppercase tracking-wide">
                  ژمارە تەلەفۆن
                </p>
              </div>
              <button
                onClick={() => window.location.href = 'tel:+964123456789'}
                className="text-[10px] font-bold text-blue-900 hover:text-blue-600 transition break-all text-left hover:underline"
              >
                +964 750 XXX XXXX
              </button>
            </div>
            ...
            {/* Opening Hours Card */}
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg p-2 border-2 border-amber-200">
              <div className="flex items-center gap-1.5 mb-1.5">
                <div className="bg-amber-500 rounded-full p-1">
                  <Clock size={12} className="text-white" />
                </div>
                <p className="text-[7px] font-bold text-amber-900 uppercase tracking-wide">
                  کراوەیە
                </p>
              </div>
            ...
            {/* Location Card */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-2 border-2 border-purple-200">
              <div className="flex items-center gap-1.5 mb-1.5">
                <div className="bg-purple-500 rounded-full p-1">
                  <MapPin size={12} className="text-white" />
                </div>
                <p className="text-[7px] font-bold text-purple-900 uppercase tracking-wide">
                  ناونیشان
                </p>
              </div>
              <p className="text-[9px] text-purple-900 font-semibold leading-snug">
                شاری کوردستان - بازاڕ
              </p>
            </div>
            ...
            <Button
              ...
              className="w-full mt-2 bg-[#386641] hover:bg-[#2a4d30] text-white rounded-lg py-1.5 md:py-2 font-semibold text-xs"
            >
              داخستن
            </Button>
