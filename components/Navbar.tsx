      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-[90vw] max-w-md md:max-w-lg max-h-[85vh] overflow-y-auto p-3 md:p-6">
          ...
          <div className="bg-white rounded-t-3xl p-3 space-y-2">
            ...
            {/* Social Media Card */}
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg px-2 md:px-4 py-5 md:py-4 border border-pink-200">
            ...
            {/* Phone Numbers Card */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg px-2 md:px-4 py-5 md:py-4 border-2 border-blue-200">
            ...
            {/* Opening Hours Card */}
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg px-2 md:px-4 py-5 md:py-4 border-2 border-amber-200">
              <div className="flex items-center gap-2 mb-2">
            ...
            {/* Location Card */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg px-2 md:px-4 py-5 md:py-4 border-2 border-purple-200">
              <div className="flex items-center gap-2 mb-2">
